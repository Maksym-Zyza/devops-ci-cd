...
## Lesson 7: Kubernetes Cluster, ECR, and Helm Charts with Terraform

Цей проєкт розгортає Kubernetes кластер на AWS за допомогою Terraform, налаштовує Elastic Container Registry (ECR) для Docker-образів, а також створює Helm Chart для розгортання Django-застосунку з використанням ConfigMap для змінних середовища.
...
│   │   ├── node.tf          # Створення нод-групи для EKS
