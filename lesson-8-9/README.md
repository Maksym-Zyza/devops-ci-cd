...
Перед застосуванням конфігурації створіть файл `terraform.tfvars` у корені проєкту:

1. Додайте рядок: `github_pat = "ваш_справжній_токен"`
2. Переконайтеся, що цей файл ігнорується Git (вже додано до `.gitignore`).
